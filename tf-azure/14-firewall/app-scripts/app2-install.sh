...
sudo echo "Welcome to stacksimplify - WebVM app2 - app2 Status Page" > /var/www/html/app2/status.html
sudo echo '<!DOCTYPE html> <html> <body style="background-color:rgb(250, 210, 210);"> <h1>Welcome to Stack Simplify - WebVM app2 </h1> <p>Terraform Demo</p> <p>app2lication Version: V1</p> </body></html>' | sudo tee /var/www/html/app2/index.html
